...
const Home = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#0d1117] text-[#e6edf3] flex flex-col items-center justify-center px-[1rem] py-[1rem] gap-[1rem] relative">
      {/* Logout button */}
      <button
        onClick={handleHomeLogout}
        className="absolute top-4 right-4 sm:top-6 sm:right-6 flex items-center gap-[0.5rem] px-[1rem] py-[0.5rem] bg-[#161b22] border border-[#2a3348] text-[#e6edf3] text-[0.85rem] font-[600] rounded-[0.5rem] hover:border-[#ff2d78]/40 hover:text-[#ff2d78] transition cursor-pointer"
      >
        <svg
        ...
        <div className="flex min-h-[520px]">
          ...
          <div className="flex-1 flex flex-col gap-[1rem] p-[1.5rem] relative">
            <div className="flex items-center gap-[0.5rem] mb-[0.25rem]">
              ...
              <h2 className="text-[1rem] font-[600] flex-1">
...
e.g. 'Senior Frontend Engineer at Google requires proficiency in React, TypeScript, and large-scale system design...'`}
          ...
          <div className="flex-1 flex flex-col gap-[0.75rem] p-[1.5rem]">
            ...
            {/* Self desc */}
            <div className="flex flex-col gap-[0.5rem]">
              <label className="text-[0.875rem] font-[500]">
      ...
      {reports.length > 0 && (
        <section className="flex flex-col gap-[0.75rem] w-full max-w-[900px]">
          <h2 className="text-xl font-medium">My Recent Interview Plans</h2>

          <ul className="flex flex-col  flex-wrap gap-[0.75rem]">
            {reports.map((report) => (
              <li
                key={report._id}
      ...
      <footer className="flex gap-[1.5rem]">
        <a
          href="#"
          className="text-[0.8rem] text-[#7d8590] hover:text-[#e6edf3]"
        >
          Privacy Policy
        </a>
        <a
